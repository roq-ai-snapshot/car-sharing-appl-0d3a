  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application - Empowering you to explore the world, one shared ride at a time. Discover a new way to travel, save, and connect."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application - Empowering you to explore the world, one shared ride at a time. Discover a new way to travel, save, and connect.`}
            </Text>
            <Box
